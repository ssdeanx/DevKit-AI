...
export const BrainIcon: React.FC<IconProps> = (props) => (
  <svg {...props} xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
    ...
    <path d="M17.5 9.5A2.5 2.5 0 0 1 20 12v0a2.5 2.5 0 0 1-2.5 2.5h0A2.5 2.5 0 0 1 15 12v0a2.5 2.5 0 0 1 2.5-2.5Z" />
    <path d="M6.5 9.5A2.5 2.5 0 0 1 9 12v0a2.5 2.5 0 0 1-2.5 2.5h0A2.5 2.5 0 0 1 4 12v0a2.5 2.5 0 0 1 2.5-2.5Z" />
    <path d="M15 15.5a2.5 2.5 0 0 1 2.5 2.5v0a2.5 2.5 0 0 1-2.5 2.5h0a2.5 2.5 0 0 1-2.5-2.5v0a2.5 2.5 0 0 1 2.5-2.5Z" />
    <path d="M9 15.5a2.5 2.5 0 0 1 2.5 2.5v0a2.5 2.5 0 0 1-2.5 2.5h0a2.5 2.5 0 0 1-2.5-2.5v0a2.5 2.5 0 0 1 2.5-2.5Z" />
    <path d="M16 8.5a1 1 0 0 1 1-1" />
    <path d="M19 12h.5a1 1 0 0 1 1 1" />
    <path d="M16 15.5a1 1 0 0 1 1 1" />
    <path d="M12 18.5a1 1 0 0 1-1 1" />
    <path d="M8 15.5a1 1 0 0 1-1 1" />
    <path d="M5 12h-.5a1 1 0 0 1-1-1" />
    <path d="M8 8.5a1 1 0 0 1-1-1" />
    <path d="M12 5.5a1 1 0 0 1-1-1" />
  </svg>
);
